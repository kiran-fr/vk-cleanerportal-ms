...
export const DeleteWorkmanScheduleApiGateway = (
  api: any,
  ...
  const DeleteWorkmanSchedule = api.root.addResource(
    "DeleteWorkmanScheduleApi"
  );
  ...
  const integration = new apigateway.LambdaIntegration(lambdaFunctionName, {
    ...
    requestParameters: {
      ...
      "integration.request.header.schedule_id":
        "method.request.header.schedule_id",
  ...
  DeleteWorkmanSchedule.addMethod(methodType, integration, {
    ...
    methodResponses: responseMethods(
      api,
      "DeleteWorkmanScheduleResp",
      "DeleteWorkmanScheduleError"
    ),
  });
};
