...
export const GetWorksmanScheduleApiGateway = (
    api: any,
    ...
    const integration = new apigateway.LambdaIntegration(lambdaFunctionName, {
      ...
      requestParameters: {
        ...
        "integration.request.header.schedule_date":
          "method.request.header.schedule_date",
    ...
    GetWorksmanSchedule.addMethod(methodType, integration, {
      ...
      methodResponses: responseMethods(
        api,
        "GetWorksmanScheduleResp",
        "GetWorksmanScheduleError"
      ),
    });
  };