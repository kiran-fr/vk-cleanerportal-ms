...
export const CreateWorksmanScheduleApiGateway = (
    api: any,
    ...
    const CreateWorksmanSchedule = api.root.addResource(
      "CreateWorksmanScheduleApi"
    );
  
    const CreateWorksmanScheduleModel: apigateway.Model = api.addModel(
      "CreateWorksmanScheduleModel",
      {
        schema: {
    ...
    CreateWorksmanSchedule.addMethod(methodType, integration, {
      ...
      methodResponses: postresponseMethods(
        api,
        "CreateWorksmanScheduleRes",
        "CreateWorksmanScheduleError"
      ),
    });
  };