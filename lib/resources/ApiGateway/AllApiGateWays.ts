...
export const WorksmnaScheduleApiGateway = (api: any, lambdaFunctionName: any, methodType: string) => {
...
export const GetAllPostcodesApiGateway = (api: any, lambdaFunctionName: any, methodType: string) => {
...
export const GetWorksmanScheduleApiGateway = (api: any, lambdaFunctionName: any, methodType: string) => {
...
// DELETE METHODS
export const DeletePostcodesApiGateway = (api: any, lambdaFunctionName: any, methodType: string) => {
...
export const DeleteWorkmanScheduleApiGateway = (api: any, lambdaFunctionName: any, methodType: string) => {
...
// UPDATE METHOD
export const UpdateWorksmanDetailsApiGateway = (api: any, lambdaFunctionName: any, methodType: string) => {
...
export const UserPostCodesApiGateway = (api: any, lambdaFunctionName: any, methodType: string) => {
  ...
  UserPostCodes.addMethod(methodType, integration, {
    ...
    //   // validateRequestParameters: true
    // },
    methodResponses: postresponseMethods(api, "UserPostCodesRes", "UserPostCodesError")
  });
}
