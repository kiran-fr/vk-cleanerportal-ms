...
export const getAllMobileNumbereApiGateway = (api: any, lambdaFunctionName: any, methodType: string) => {

  // 👇 add a /todos resource
  const getAllMobileNumbereApiGateway = api.root.addResource('getAllMobileNumbereApiGateway');
  ...
  getAllMobileNumbereApiGateway.addMethod(methodType, integration, {
...
export const GetTestUserApiGateway = (api: any, lambdaFunctionName: any, methodType: string) => {
  ...
  GetTestUser.addMethod('GET', integration, {
    ...
    //   validateRequestParameters: true
    // },
    methodResponses: responseMethods(api,"GetTestUser","GetTestUserError")
  });
}
