...
export const GetListOfJobsBasedOnMonthApiGateway = (api: any, lambdaFunctionName: any, methodType: string, authorizations: any) => {
  // GetWorksmanjobsLambdaApi
  // 👇 add a /todos resource
  const GetListOfJobsBasedOnMonth = api.root.addResource('GetListOfJobsBasedOnMonthApi');
  ...
  const integration = new apigateway.LambdaIntegration(lambdaFunctionName, {
    ...
    requestParameters: {
      ...
      // 'integration.request.querystring.worksmanId': 'method.request.querystring.worksmanId'
      'integration.request.header.worksman_id': 'method.request.header.worksman_id',
      'integration.request.header.job_mon_year': 'method.request.header.job_mon_year'
  ...
  GetListOfJobsBasedOnMonth.addMethod(methodType, integration, {
    ...
    //   validateRequestParameters: true
    // },
    methodResponses: responseMethods(api, "GetListOfJobsBasedOnMonthRes", "GetListOfJobsBasedOnMonthErr")
  });
}
