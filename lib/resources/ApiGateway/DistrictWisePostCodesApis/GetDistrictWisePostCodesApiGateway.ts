...
export const GetDistrictWisePostCodesApiGateway = (
    api: any,
    ...
    const GetPaymentHistoryDetails = api.root.addResource(
      "GetDistrictWisePostCodesApi"
    );
    ...
    GetPaymentHistoryDetails.addMethod(methodType, integration, {
      ...
      methodResponses: responseMethods(
        api,
        "GetDistrictWisePostCodesRes",
        "GetDistrictWisePostCodesErr"
      ),
    });
  };