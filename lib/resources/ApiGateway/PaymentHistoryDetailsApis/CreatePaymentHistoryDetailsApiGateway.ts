...
export const CreatePaymentHistoryDetailsApiGateway = (
    api: any,
    ...
    const CreatePaymentHistoryDetails = api.root.addResource(
      "CreatePaymentHistoryDetailsApi"
    );
  
    const CreatePaymentHistoryDetailsModel: apigateway.Model = api.addModel(
      "CreatePaymentHistoryDetailsModel",
      {
        schema: {
    ...
    CreatePaymentHistoryDetails.addMethod(methodType, integration, {
      ...
      methodResponses: postresponseMethods(
        api,
        "CreatePaymentHistoryDetailsResponse",
        "CreatePaymentHistoryDetailsError"
      ),
    });
  };