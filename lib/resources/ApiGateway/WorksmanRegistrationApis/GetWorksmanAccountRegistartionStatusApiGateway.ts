...
export const GetWorksmanAccountRegistartionStatusApiGateway = (
  api: any,
  ...
  const GetWorksmanAccountRegistartionStatus = api.root.addResource(
    "GetWorksmanAccountRegistartionStatusApi"
  );
  ...
  const integration = new apigateway.LambdaIntegration(lambdaFunctionName, {
    ...
    requestParameters: {
      ...
      "integration.request.querystring.worksmanId":
        "method.request.querystring.worksmanId",
      "integration.request.header.worksmanIdHeader":
        "method.request.header.worksmanIdHeader",
      "integration.request.header.email": "method.request.header.email",
    ...
    requestTemplates: {
      ...
      "application/json": JSON.stringify({
        ...
        worksmanIdHeader:
          "$util.escapeJavaScript($input.params('worksmanIdHeader'))",
