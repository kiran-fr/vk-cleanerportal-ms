...
export const UpdateWorksmanDetailsApiGateway = (
    api: any,
    ...
    const UpdateWorksmanDetails = api.root.addResource(
      "UpdateWorksmanDetailsApi"
    );
  
    const UpdateWorksmanDetailsModel: apigateway.Model = api.addModel(
      "UpdateWorksmanDetailsModel",
      {
        schema: {
    ...
    UpdateWorksmanDetails.addMethod(methodType, integration, {
      ...
      methodResponses: postresponseMethods(
        api,
        "UpdateWorksmanDetailsRes",
        "UpdateWorksmanDetailsError"
      ),
    });
  };