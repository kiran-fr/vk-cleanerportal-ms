...
export class CdkExampleStack extends cdk.Stack {
  ...
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const userRegistration = new lambda.Function(
      this,
      "UserRegistration",
      UserRegistrationLambda()
    );
    const WorksManTermsAndCondition = new lambda.Function(
      this,
      "WorksManTermsAndCondition",
      WorksManTermsAndConditionLambda()
    );
    const WorksManExperience = new lambda.Function(
      this,
      "WorksManExperience",
      WorksManExperienceLambda()
    );
    const GetWorksmanAccountRegistartionStatus = new lambda.Function(
      this,
      "GetWorksmanAccountRegistartionStatus",
      GetWorksmanAccountRegistartionStatusLambda()
    );
    const getAllMobileNumbersDemo = new lambda.Function(
      this,
      "getAllMobileNumber",
      getAllMobileNumberLambda()
    );
    const GetWorkmanDetailLambda = new lambda.Function(
      this,
      "GetWorkmanDetails",
      GetWorkmanDetailsLambda()
    );
    const UpdateWorksmanDetailLambda = new lambda.Function(
      this,
      "UpdateWorksmanDetail",
      UpdateWorksmanDetailsLambda()
    );
    const UserPostCodeLambdaApi = new lambda.Function(
      this,
      "UserPostCodes",
      UserPostCodesLambda()
    );
    const GetAllPostcodesLambdaApi = new lambda.Function(
      this,
      "GetAllPostcodes",
      GetAllPostcodesLambda()
    );
    const DeletePostcodesLambdaApi = new lambda.Function(
      this,
      "DeletePostcodes",
      DeletePostcodesLambda()
    );
    const CreateWorksmanScheduleLambdaApi = new lambda.Function(
      this,
      "CreateWorksmanSchedule",
      CreateWorksmanScheduleLambda()
    );
    const DeleteWorkmanScheduleLambdaApi = new lambda.Function(
      this,
      "DeleteWorkmanSchedule",
      DeleteWorkmanScheduleLambda()
    );
    const GetWorksmanScheduleLambdaApi = new lambda.Function(
      this,
      "GetWorksmanSchedule",
      GetWorksmanSchedulesLambda()
    );
    const GetWorksmanjobsLambdaApi = new lambda.Function(
      this,
      "GetWorksmanjobs",
      GetWorksmanjobsLambda()
    );
    const WorksmanjobsCreateLambdaApi = new lambda.Function(
      this,
      "WorksmanjobsCreate",
      WorksmanjobsCreateLambda()
    );
    const CreateBankDetailsLambdaApi = new lambda.Function(
      this,
      "CreateBankDetails",
      CreateBankDetailsLambda()
    );
    const GetBankDetailsLambdaApi = new lambda.Function(
      this,
      "GetBankDetails",
      GetBankDetailsLambda()
    );
    const CreateMessagesLambdaApi = new lambda.Function(
      this,
      "CreateMessages",
      CreateMessagesLambda()
    );
    const GetMessagesLambdaApi = new lambda.Function(
      this,
      "GetMessages",
      GetMessagesLambda()
    );
    ...
    const GetJobsLambdaApi = new lambda.Function(
      this,
      "GetJobs",
      GetJobsLambda()
    );
    const GetListOfJobsBasedOnMonthLambdaApi = new lambda.Function(
      this,
      "GetListOfJobsBasedOnMonth",
      GetListOfJobsBasedOnMonthLambda()
    );
    const GetPaymentDetailsLambdaApi = new lambda.Function(
      this,
      "GetPaymentDetails",
      GetPaymentDetailsLambda()
    );
    const CreatePaymentHistoryDetailsLambdaApi = new lambda.Function(
      this,
      "CreatePaymentHistoryDetails",
      CreatePaymentHistoryDetailsLambda()
    );
    const GetPaymentHistoryDetailsLambdaApi = new lambda.Function(
      this,
      "GetPaymentHistoryDetails",
      GetPaymentHistoryDetailsLambda()
    );
    const GetDistrictWisePostCodesLambdaApi = new lambda.Function(
      this,
      "GetDistrictWisePostCodes",
      GetDistrictWisePostCodesLambda()
    );
    const UpdateBankDetailsLambdaApi = new lambda.Function(
      this,
      "UpdateBankDetails",
      UpdateBankDetailsLambda()
    );
    ...
    const api = new apigateway.RestApi(
      this,
      "WorksmanApiData",
      ApigatewayDataConstants(apigateway)
    );
    ...
    CreateWorksmanScheduleApiGateway(
      api,
      CreateWorksmanScheduleLambdaApi,
      "POST",
      auth
    );
    CreateJobsApiGateway(api, WorksmanjobsCreateLambdaApi, "POST", auth);
    ...
    GetListOfJobsBasedOnMonthApiGateway(
      api,
      GetListOfJobsBasedOnMonthLambdaApi,
      "GET",
      auth
    );
    ...
    GetPaymentHistoryDetailsApiGateway(
      api,
      GetPaymentHistoryDetailsLambdaApi,
      "GET",
      auth
    );
    GetDistrictWisePostCodesApiGateway(
      api,
      GetDistrictWisePostCodesLambdaApi,
      "GET",
      auth
    );
    ...
    DeleteWorkmanScheduleApiGateway(
      api,
      DeleteWorkmanScheduleLambdaApi,
      "DELETE",
      auth
    );
